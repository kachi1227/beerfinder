...
+ (NSMutableArray*)colorsWithStrings:(NSArray*)arrayOfStrings
{
    NSMutableArray* colors = [[NSMutableArray alloc] initWithCapacity: [arrayOfStrings count]];
    
    for (NSString* string in arrayOfStrings) {
        [colors addObject:[UIColor colorWithString:string]];
    }
    return colors;
}
